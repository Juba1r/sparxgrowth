    ...
    <section className="py-28 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ background: "#2563eb", top: "30%", right: "5%", transform: "translateY(-50%)" }}
        />
      </div>

      <div className="section-container-sm">
        <AnimatedSection className="text-center mb-16">
          <span className="section-tag mb-5 inline-flex">Testimonials</span>
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            ...
            >
              <Quote size={40} className="mx-auto mb-6 opacity-20 text-blue-400" />
              ...
              <p className="text-white/80 text-lg sm:text-xl leading-relaxed mb-8 text-balance max-w-2xl mx-auto">
